...
/** The painted region backdrops, by file stem under public/art/regions. */
...
export type RegionArt = (typeof REGION_ART)[number];

export interface Location {
  readonly name: string;
  /** Which painted backdrop the map is drawn over. */
  readonly region: RegionArt;
